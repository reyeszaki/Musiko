...
<body>
  ...
  <header class="sticky">
    ...
    <div class="main">
      ...
      if(!isset($_SESSION['username'])){
        ...
        echo "<a href='register.php' class='regis'>Register</a>";
      }else{
  ...
  <section class="home" id="home">
    <div class="home-text">
      <h1>Discover New<br><span>Music</span></h1>
      <p>Save tracks, follow artists and build playlists.</p>
      <a href="tracks.php" class="btn">View tracks</a>
  </section>
  ...
  <section class="featured" id="featured">
    ...
    <div class="featured-content">
      ...
      <div class="row">
        ...
        <section class="cta">
          <div class="cta-text">
            <h6>Discover Artists</h6>
            <a href="artists.php" class="btn">View Artists</a>
          </div>
        </section>
